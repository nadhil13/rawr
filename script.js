...
function changeBackgroundImage() {
    ...
    // Ganti gambar latar belakang berdasarkan kondisi
    if (isBackground1Visible) {
        bg2.style.backgroundImage = `url(${images[currentImageIndex]})`;
        bg2.classList.add('visible');  // Tampilkan bg2 secara perlahan
        bg1.classList.remove('visible');  // Sembunyikan bg1 secara perlahan
    } else {
        bg1.style.backgroundImage = `url(${images[currentImageIndex]})`;
        bg1.classList.add('visible');  // Tampilkan bg1 secara perlahan
        bg2.classList.remove('visible');  // Sembunyikan bg2 secara perlahan
    }

    // Update indeks gambar untuk background berikutnya
